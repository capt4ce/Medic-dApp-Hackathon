...
contractAddress = '0xb21b64e35b0a8b01230759cfeea4ff9e3c59ad84';
...
treatmentGenerator.forEach(function (val, i) {
    startFrom = 5
    contractInstance.issueTreatmentRecord(web3.eth.accounts[i + startFrom], val.treatment, val.status, val.disease, { from: web3.eth.accounts[i] }, function () {
