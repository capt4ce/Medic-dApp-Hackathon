...
for (var i = 0; i < 5; i++) {
    ...
    contractInstance.addPatient('abc', patientGenerator[i].age, patientGenerator[i].sex, patientGenerator[i].currentDisease, patientGenerator[i].currentTreatment, patientGenerator[i].treatmentConstraints, patientGenerator[i].diseaseSeverity, { from: web3.eth.accounts[i + startFrom], gas: 3000000 }, function (e, r) {
        console.log(e)
        console.log(r)
    })
}
